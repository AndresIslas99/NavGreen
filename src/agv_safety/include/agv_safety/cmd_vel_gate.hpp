...
class CmdVelGateNode : public rclcpp::Node {
 ...
 private:
  ...
  // NOT fire while last_safety_msg_ is unset — so the startup window
  // is "always zero" rather than "always zero after a short grace".
  // Verified 2026-05-13 (Sprint D, HIGH-09-04).
