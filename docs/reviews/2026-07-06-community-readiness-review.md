...
| 67 | high | community | `src/agv_bringup/config/sites/example/site.yaml` | The paying customer's identity ('Example Farm', Mexico) is committed as the default launch site config, alongside real development-LAN IPs and ssh targets — publicly ty... | Partially fixed |
