...
| 67 | high | community | `src/agv_bringup/config/sites/<redacted>/site.yaml` | The paying customer's identity (<customer>, Mexico) is committed as the default launch site config, alongside real development-LAN IPs and ssh targets — publicly ty... | Partially fixed |
